...
in
{
  options.${namespace}.desktop.addons.gtk = with types; {
    ...
    cursor = {
      name = mkOpt str "breeze-hacked-cursor-theme"
        "The name of the cursor theme to apply.";
      pkg = mkOpt package pkgs.breeze-hacked-cursor-theme "The package to use for the cursor theme.";
    };
    icon = {
      name = mkOpt str "gruvbox-plus-icons"
