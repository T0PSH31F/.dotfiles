          ...
          (template-name: template:
            {
              ...
              message = "t0psh31f.services.vault-agent.services.${service-name}.secrets.environment.templates.${template-name} must set either `source` or `text`.";
            }
          )
          ...
          (file-name: file:
            {
              ...
              message = "t0psh31f.services.vault-agent.services.${service-name}.secrets.file.files.${file-name} must set either `source` or `text`.";
            }
          )
