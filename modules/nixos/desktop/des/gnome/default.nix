...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    systemd.services.t0psh31f-user-icon = {
      ...
      script = ''
        ...
        icon_file=/run/current-system/sw/share/t0psh31f-icons/user/${config.${namespace}.user.name}/${config.${namespace}.user.icon.fileName}
